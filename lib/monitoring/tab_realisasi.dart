    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Row(children: [
            Expanded(child: MonitoringDateField(label: 'Tgl. Pelimpahan Awal', controller: _tglPelimpahanAwal)),
            const SizedBox(width: 8),
            Expanded(child: MonitoringDateField(label: 'Tgl. Pelimpahan Akhir', controller: _tglPelimpahanAkhir)),
          ]),
          ...
          MonitoringResultView(result: _result, loading: false, reportTitle: 'Realisasi'),
        ],
      ),
    );
  }
